/// Returns the square root of a floating-point number `n` using Newton's method.
...
mod tests {
    ...
    fn test_sqrt() {
        ...
        for _ in 0..1000 {
            sqrt_checked(rng.random_range(0.0..f32::MAX));
        }
    }
    ...
    fn test_isqrt() {
        for i in 0..0xffff {
            assert_eq!(isqrt(i), (i as f64).sqrt() as u32);
        }
    }
}
